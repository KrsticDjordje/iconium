            ...
            <div class="flex justify-between h-16 items-center">
              ...
              <div class="flex items-center gap-2 sm:gap-4">
                <div class="w-full max-w-[200px] sm:max-w-md">
                  <div class="relative">
                    <input type="search" v-model="searchQuery" :placeholder="t('app.searchPlaceholder')" class="w-full pl-10 pr-4 py-2 text-sm sm:text-base rounded-lg border border-gray-300 
                ...
                <!-- Language Toggle -->
                <button @click="toggleLanguage" class="p-2 rounded-lg bg-gray-100 dark:bg-gray-700 text-gray-500 
